...
// let componentAddress = "component_tdx_2_1cz34c6f3dltu9j8px5az7fhdugfsx4k6nz0qugjnyh9yrdhkg6qce7"; // GumballMachine component address on Stokenet
...
document.getElementById("instantiateComponent").onclick = async function () {
  ...
  componentAddress = committedDetails.transaction.affected_global_entities[1];
  ownerBadgeAddress = committedDetails.transaction.affected_global_entities[2];
  ...
  console.log("ownerBadgeAddress: ", ownerBadgeAddress);
  console.log("gumballResourceAddress: ", gumballResourceAddress);
